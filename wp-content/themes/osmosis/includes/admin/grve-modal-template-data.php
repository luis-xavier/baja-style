...
<div>
	<script type="text/html" id='grve_backbone_modal_window'>
		<div class="grve-modal">
			<a class="grve-modal-close" href="#" title="<?php echo esc_attr__( 'Close' , 'osmosis' );?>">
				<span class="grve-modal-icon ir"><?php echo esc_html__( 'Close' , 'osmosis' );?></span>
			</a>
				...
				<section class="grve-modal-main" role="main">
					...
					<footer>
						<div class="inner text-right">
							<button id="grve-modal-btn-cancel" class="button button-large"><?php echo esc_html__( 'Cancel' , 'osmosis' );?></button>
							<button id="grve-modal-btn-ok" class="button button-primary button-large"><?php echo esc_html__( 'Save' , 'osmosis' );?></button>
						</div>
					</footer>
				</section>
			</div>
	...
	<script type="text/html" id='grve-select-bg-image-size-template'>
		<div class="grve-modal-element-container">
			<div class="grve-modal-element grve-modal-element-left">
				<span class="grve-modal-label"><%= title %></span>
				<span class="grve-modal-description"><%= desc %></span>
			...
			<div class="grve-modal-element grve-modal-element-left">
			<select name="<%= name %>" data-meta-id="<%= id %>" data-meta-value="<%=value%>" class="grve-modal-select">
				<?php grve_print_media_bg_image_size_selection(); ?>
			</select>
			</div>
		</div>
	</script>
	...
	<script type="text/html" id='grve-select-bg-position-inherit-template'>
		<div class="grve-modal-element-container">
			<div class="grve-modal-element grve-modal-element-left">
				<span class="grve-modal-label"><%= title %></span>
				<span class="grve-modal-description"><%= desc %></span>
			...
			<div class="grve-modal-element grve-modal-element-left">
			<select name="<%= name %>" data-meta-id="<%= id %>" data-meta-value="<%=value%>" class="grve-modal-select">
				<?php grve_print_media_bg_position_inherit_selection(); ?>
			</select>
			</div>
		</div>
	</script>
	...
	<script type="text/html" id='grve-select-tag-template'>
		<div class="grve-modal-element-container">
			<div class="grve-modal-element grve-modal-element-left">
				<span class="grve-modal-label"><%= title %></span>
				<span class="grve-modal-description"><%= desc %></span>
			...
			<div class="grve-modal-element grve-modal-element-left">
			<select name="<%= name %>" data-meta-id="<%= id %>" data-meta-value="<%=value%>" class="grve-modal-select">
				<?php grve_print_media_tag_selection(); ?>
			</select>
			</div>
		</div>
	</script>
	...
	<script type="text/html" id='grve-select-boolean-template'>
		<div class="grve-modal-element-container">
			<div class="grve-modal-element grve-modal-element-left">
				<span class="grve-modal-label"><%= title %></span>
				<span class="grve-modal-description"><%= desc %></span>
			...
			<div class="grve-modal-element grve-modal-element-left">
			<select name="<%= name %>" data-meta-id="<%= id %>" data-meta-value="<%=value%>" class="grve-modal-select">
				<?php grve_print_media_boolean_selection(); ?>
			</select>
			</div>
		</div>
	</script>
