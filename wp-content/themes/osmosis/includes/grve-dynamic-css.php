...
/* Header Height */
$grve_header_mode = grve_option( 'header_mode', 'default' );
if ( 'default' == $grve_header_mode ) {
	...
	$grve_header_height = intval( grve_option( 'header_top_height', 90 ) ) + intval( grve_option( 'header_bottom_height', 60 ) );
	$css .= "
	#grve-header #grve-inner-header,
	#grve-header #grve-header-wrapper {
		height: " . esc_attr( $grve_header_height ) . "px;
	}

	#grve-header .grve-top-header {
		height: " . grve_option( 'header_top_height', 90 ) . "px;
		line-height: " . grve_option( 'header_top_height', 90 ) . "px;
	}

	#grve-header #grve-inner-header .grve-logo img {
		max-height: " . grve_option( 'header_top_height', 90 ) . "px;
	}

	#grve-header .grve-bottom-header {
		height: " . grve_option( 'header_bottom_height', 60 ) . "px;
		line-height: " . grve_option( 'header_bottom_height', 60 ) . "px;
	}
	...
	@media only screen and (min-width: 1024px) {
		#grve-header[data-overlap='yes'][data-header-position='above-feature'] .grve-feature-content {
			padding-top: " . grve_option( 'header_top_height', 90 ) . "px;
		}
	}
...
$css .= "
.grve-breadcrumbs {
	background-color: " . grve_option( 'page_breadcrumbs_background_color' ) . ";
	border-color: " . grve_option( 'page_breadcrumbs_border_color' ) . ";
}

.grve-breadcrumbs ul li {
	color: " . grve_option( 'page_breadcrumbs_divider_color' ) . ";
}

.grve-breadcrumbs ul li a {
	color: " . grve_option( 'page_breadcrumbs_text_color' ) . ";
}

.grve-breadcrumbs ul li a:hover {
	color: " . grve_option( 'page_breadcrumbs_text_hover_color' ) . ";
}
...
#grve-page-breadcrumbs {
	line-height: " . grve_option( 'page_breadcrumbs_height', '60' ) . "px;
}
...
#grve-post-breadcrumbs {
	line-height: " . grve_option( 'post_breadcrumbs_height', '60' ) . "px;
}
...
#grve-portfolio-breadcrumbs {
	line-height: " . grve_option( 'portfolio_breadcrumbs_height', '60' ) . "px;
}
...
#grve-product-breadcrumbs {
	line-height: " . grve_option( 'product_breadcrumbs_height', '60' ) . "px;
}
...
function osmosis_grve_print_css_colors() {

	$grve_colors = osmosis_grve_get_color_array();

	$css = '';

	foreach ( $grve_colors as $key => $value ) {
...
$css .= osmosis_grve_print_css_colors();
...
/* GDPR Privacy
============================================================================= */
$osmosis_grve_privacy_bar_bg_color = grve_option( 'privacy_bar_bg_color', '#000000' );
$css .= "

#grve-privacy-bar {
	background-color: rgba(" . grve_hex2rgb( $osmosis_grve_privacy_bar_bg_color ) . "," . grve_option( 'privacy_bar_bg_opacity', '0.90') . ");
	color: " . grve_option( 'privacy_bar_text_color' ) . ";
}

.grve-privacy-agreement {
	background-color: " . grve_option( 'privacy_bar_button_bg_color' ) . ";
	color: " . grve_option( 'privacy_bar_button_text_color' ) . ";
}

.grve-privacy-refresh-btn {
	background-color: " . grve_option( 'privacy_modal_button_bg_color' ) . ";
	color: " . grve_option( 'privacy_modal_button_text_color' ) . ";
}
...
.grve-privacy-agreement:hover {
	background-color: " . grve_option( 'privacy_bar_button_bg_hover_color' ) . ";
}

.grve-privacy-refresh-btn:hover {
	background-color: " . grve_option( 'privacy_modal_button_bg_hover_color' ) . ";
}
