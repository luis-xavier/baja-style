<?php
    ...
    class Redux_Welcome {
	    ...
	    //REDUX_MOD_TOM
            ...
            // About Page
            $page(
                esc_html__( 'Welcome to Redux Framework', 'osmosis' ), esc_html__( 'Redux Framework', 'osmosis' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            $page(
                esc_html__( 'Redux Framework Changelog', 'osmosis' ), esc_html__( 'Redux Framework Changelog', 'osmosis' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Get Support', 'osmosis' ), esc_html__( 'Get Support', 'osmosis' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Redux Extensions', 'osmosis' ), esc_html__( 'Redux Extensions', 'osmosis' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            $page(
                esc_html__( 'The people that develop Redux Framework', 'osmosis' ), esc_html__( 'The people that develop Redux Framework', 'osmosis' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            $page(
                esc_html__( 'Redux Framework Status', 'osmosis' ), esc_html__( 'Redux Framework Status', 'osmosis' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
        ...
        public function tabs() {
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo 'redux-about' == $selected ? 'nav-tab-active' : ''; ?>"
                    ...
                    <?php esc_attr_e( "What's New", 'osmosis' ); ?>
                    ...
                    <?php esc_attr_e( 'Extensions', 'osmosis' ); ?>
                    ...
                    <?php esc_attr_e( 'Changelog', 'osmosis' ); ?>
                    ...
                    <?php esc_html_e( 'Credits', 'osmosis' ); ?>
                    ...
                    <?php esc_attr_e( 'Support', 'osmosis' ); ?>
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'osmosis' ), esc_html( $contributor->login ) ) )
                );
