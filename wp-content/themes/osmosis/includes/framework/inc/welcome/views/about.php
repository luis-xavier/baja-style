<div class="wrap about-wrap">
    <h1><?php printf( __( 'Welcome to Redux Framework %s', 'osmosis' ), $this->display_version ); ?></h1>

    <div
        class="about-text"><?php printf( __( 'Thank you for updating to the latest version! Redux Framework %s is a huge step forward in Redux Development. Look at all that\'s new.', 'osmosis' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
            class="el el-redux"></i><span><?php printf( __( 'Version %s', 'osmosis' ), ReduxFramework::$_version ); ?></span>
    </div>
    ...
    <div id="redux-message" class="updated">
        <h4><?php esc_html_e( 'What is Redux Framework?', 'osmosis' ); ?></h4>
        ...
        <p><?php esc_html_e( 'Redux Framework is the core of many products on the web. It is an option framework which developers use to
            enhance their products.', 'osmosis' ); ?></p>

        <p class="submit">
            <a class="button-primary" href="<?php echo 'http://';?>reduxframework.com"
               target="_blank"><?php esc_html_e( 'Learn More', 'osmosis' ); ?></a>
        </p>
    </div>

    <div class="changelog">

        <h2><?php esc_html_e( 'New in this Release', 'osmosis' ); ?></h2>
