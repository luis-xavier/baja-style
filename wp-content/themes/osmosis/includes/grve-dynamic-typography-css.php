...
h1,
.grve-h1,
.woocommerce h1.grve-widget-title {
...
h2,
.grve-h2,
.woocommerce h2.grve-widget-title {
...
.grve-blog .grve-post-comments span,
.grve-add-cart,
.grve-map-infotext p,
...
.grve-team-social.grve-team-social-icon li a {
...
#grve-main-content .vc_tta-accordion .vc_tta-panel-title {
	...
	font-weight: " . grve_option( 'subtitle_text', 'normal', 'font-weight'  ) . ";
	font-style: " . grve_option( 'subtitle_text', 'normal', 'font-style'  ) . ";
	font-size: " . grve_option( 'subtitle_text', '18px', 'font-size'  ) . " !important;
	text-transform: " . grve_option( 'subtitle_text', 'none', 'text-transform'  ) . ";
	" . grve_css_option( 'subtitle_text', '', 'letter-spacing'  ) . "
}
...
echo grve_get_css_output( $typo_css );
