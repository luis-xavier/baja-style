...
if( !function_exists( 'grve_osmosis_vce_progress_bar_shortcode_params' ) ) {
	function grve_osmosis_vce_progress_bar_shortcode_params( $tag ) {
		return array(
...
if( function_exists( 'vc_lean_map' ) ) {
	vc_lean_map( 'grve_progress_bar', 'grve_osmosis_vce_progress_bar_shortcode_params' );
} else if( function_exists( 'vc_map' ) ) {
	$attributes = grve_osmosis_vce_progress_bar_shortcode_params( 'grve_progress_bar' );
	vc_map( $attributes );
}
