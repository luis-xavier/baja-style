...
if( !function_exists( 'grve_osmosis_vce_dropcap_shortcode_params' ) ) {
	function grve_osmosis_vce_dropcap_shortcode_params( $tag ) {
		return array(
...
if( function_exists( 'vc_lean_map' ) ) {
	vc_lean_map( 'grve_dropcap', 'grve_osmosis_vce_dropcap_shortcode_params' );
} else if( function_exists( 'vc_map' ) ) {
	$attributes = grve_osmosis_vce_dropcap_shortcode_params( 'grve_dropcap' );
	vc_map( $attributes );
}
