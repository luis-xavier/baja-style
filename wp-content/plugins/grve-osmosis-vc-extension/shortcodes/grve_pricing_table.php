...
if( !function_exists( 'grve_osmosis_vce_pricing_table_shortcode_params' ) ) {
	function grve_osmosis_vce_pricing_table_shortcode_params( $tag ) {
		return array(
...
if( function_exists( 'vc_lean_map' ) ) {
	vc_lean_map( 'grve_pricing_table', 'grve_osmosis_vce_pricing_table_shortcode_params' );
} else if( function_exists( 'vc_map' ) ) {
	$attributes = grve_osmosis_vce_pricing_table_shortcode_params( 'grve_pricing_table' );
	vc_map( $attributes );
}
