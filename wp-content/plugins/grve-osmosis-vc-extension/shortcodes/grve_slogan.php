...
if( !function_exists( 'grve_slogan_shortcode' ) ) {
	...
	function grve_slogan_shortcode( $atts, $content ) {
		...
		if ( !empty( $title ) ) {
			$output .= '<' . tag_escape( $heading ) . ' class="' . esc_attr( $title_class_string ) . '"><span>' . $title . '</span></' . tag_escape( $heading ) . '>';
		}
...
if( !function_exists( 'grve_osmosis_vce_slogan_shortcode_params' ) ) {
	function grve_osmosis_vce_slogan_shortcode_params( $tag ) {
		return array(
...
if( function_exists( 'vc_lean_map' ) ) {
	vc_lean_map( 'grve_slogan', 'grve_osmosis_vce_slogan_shortcode_params' );
} else if( function_exists( 'vc_map' ) ) {
	$attributes = grve_osmosis_vce_slogan_shortcode_params( 'grve_slogan' );
	vc_map( $attributes );
}
