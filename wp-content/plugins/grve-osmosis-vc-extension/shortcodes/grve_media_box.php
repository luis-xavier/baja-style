	...
	function grve_media_box_shortcode( $atts, $content ) {
		...
		switch( $media_type ) {
			...
			case 'map':
				...
				$output .= '<div class="grve-media">';
				$output .= '<div class="grve-map" ' . $data_map . ' style="' . $style . grve_osmosis_vce_build_dimension( 'height', $map_height ) . '">';
				$output .= apply_filters( 'grve_privacy_gmap_fallback', '', $map_lat, $map_lng );
				$output .= '</div>';
		...
		$output .= '    <a href="' . esc_url( $url ) . '" target="' . esc_attr( $target ) . '" class="grve-read-more">';
...
if( !function_exists( 'grve_osmosis_vce_media_box_shortcode_params' ) ) {
	function grve_osmosis_vce_media_box_shortcode_params( $tag ) {
		return array(
...
if( function_exists( 'vc_lean_map' ) ) {
	vc_lean_map( 'grve_media_box', 'grve_osmosis_vce_media_box_shortcode_params' );
} else if( function_exists( 'vc_map' ) ) {
	$attributes = grve_osmosis_vce_media_box_shortcode_params( 'grve_media_box' );
	vc_map( $attributes );
}
