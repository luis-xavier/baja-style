 ...
 */
if( !function_exists( 'grve_osmosis_vce_add_animation' ) ) {
	function grve_osmosis_vce_add_animation() {
		return array(
			"type" => "dropdown",
...
if( !function_exists( 'grve_osmosis_vce_add_animation_delay' ) ) {
	function grve_osmosis_vce_add_animation_delay() {
		return array(
			"type" => "textfield",
...
if( !function_exists( 'grve_osmosis_vce_add_margin_bottom' ) ) {
	function grve_osmosis_vce_add_margin_bottom() {
		return array(
			"type" => "textfield",
...
if( !function_exists( 'grve_osmosis_vce_add_el_class' ) ) {
	function grve_osmosis_vce_add_el_class() {
		return array(
			"type" => "textfield",
...
if( !function_exists( 'grve_osmosis_vce_add_align' ) ) {
	function grve_osmosis_vce_add_align( $std = 'left') {
		return array(
			"type" => "dropdown",
...
if( !function_exists( 'grve_osmosis_vce_add_button_type' ) ) {
	function grve_osmosis_vce_add_button_type() {
		return array(
			"type" => "dropdown",
...
if( !function_exists( 'grve_osmosis_vce_add_button_color' ) ) {
	function grve_osmosis_vce_add_button_color() {
		return array(
			"type" => "dropdown",
...
if( !function_exists( 'grve_osmosis_vce_add_button_text' ) ) {
	function grve_osmosis_vce_add_button_text() {
		return array(
			"type" => "textfield",
...
if( !function_exists( 'grve_osmosis_vce_add_button_size' ) ) {
	function grve_osmosis_vce_add_button_size() {
		return array(
			"type" => "dropdown",
...
if( !function_exists( 'grve_osmosis_vce_add_button_shape' ) ) {
	function grve_osmosis_vce_add_button_shape() {
		return array(
			"type" => "dropdown",
...
if( !function_exists( 'grve_osmosis_vce_add_button_link' ) ) {
	function grve_osmosis_vce_add_button_link() {
		return array(
			"type" => "vc_link",
...
if( !function_exists( 'grve_osmosis_vce_add_button_class' ) ) {
	function grve_osmosis_vce_add_button_class() {
		return array(
			"type" => "textfield",
...
if( !function_exists( 'grve_osmosis_vce_add_order_by' ) ) {
	function grve_osmosis_vce_add_order_by() {
		return array(
			"type" => "dropdown",
...
if( !function_exists( 'grve_osmosis_vce_add_order' ) ) {
	function grve_osmosis_vce_add_order() {
		return array(
			"type" => "dropdown",
...
if( !function_exists( 'grve_osmosis_vce_add_slideshow_speed' ) ) {
	function grve_osmosis_vce_add_slideshow_speed() {
		return array(
			"type" => "textfield",
...
if( !function_exists( 'grve_osmosis_vce_add_pagination_speed' ) ) {
	function grve_osmosis_vce_add_pagination_speed() {
		return array(
			"type" => "textfield",
...
if( !function_exists( 'grve_osmosis_vce_add_navigation_type' ) ) {
	function grve_osmosis_vce_add_navigation_type() {
		return array(
			"type" => "dropdown",
...
if( !function_exists( 'grve_osmosis_vce_add_navigation_color' ) ) {
	function grve_osmosis_vce_add_navigation_color() {
		return array(
			"type" => "dropdown",
...
if( !function_exists( 'grve_osmosis_vce_add_auto_height' ) ) {
	function grve_osmosis_vce_add_auto_height() {
		return array(
			"type" => 'checkbox',
...
//Title Headings/Tags
if( !function_exists( 'grve_osmosis_vce_get_heading' ) ) {
	function grve_osmosis_vce_get_heading( $std = '' ) {
		return	array(
			"type" => "dropdown",
			"heading" => esc_html__( "Heading", "grve-osmosis-vc-extension" ),
			"param_name" => "heading",
			"value" => array(
			...
			"description" => esc_html__( "Heading size", "grve-osmosis-vc-extension" ),
			"std" => $std,
		);
	}
}
if( !function_exists( 'grve_osmosis_vce_get_heading_tag' ) ) {
	function grve_osmosis_vce_get_heading_tag( $std = '' ) {
		return	array(
			"type" => "dropdown",
			"heading" => esc_html__( "Heading Tag", "grve-osmosis-vc-extension" ),
			"param_name" => "heading_tag",
			"value" => array(
				esc_html__( "Same as Heading", "grve-osmosis-vc-extension" ) => '',
				esc_html__( "h1", "grve-osmosis-vc-extension" ) => 'h1',
				esc_html__( "h2", "grve-osmosis-vc-extension" ) => 'h2',
				esc_html__( "h3", "grve-osmosis-vc-extension" ) => 'h3',
				esc_html__( "h4", "grve-osmosis-vc-extension" ) => 'h4',
			...
			"description" => esc_html__( "Heading Tag for SEO", "grve-osmosis-vc-extension" ),
			"std" => $std,
		);
	}
}
